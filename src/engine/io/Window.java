...
public class Window {
  ...
  public Window(int width, int height, String title) {
    ...
    this.height = height;
    this.title = title;
    projection = Transformations.projection(70.0f, (float) width / (float) height, 0.1f, 1000.0f);
  }
  ...
  public void create() {
    ...
    GLFW.glfwSwapInterval(1); // sets fps: 1 -> capped at refresh rate, 0 -> unlimited
